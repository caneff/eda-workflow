...
def test_compute_aggregates_summarizes_notable_group_differences():
    ...
    aggregates = eda_workflow.eda_workflow.compute_aggregates(
        dataframe,
        results=results,
    )
    ...
    top_two_aggregates = eda_workflow.eda_workflow.compute_aggregates(
        dataframe,
        results=results,
        max_groups=2,
    )
    ...
    thresholded_aggregates = eda_workflow.eda_workflow.compute_aggregates(
        dataframe,
        results=results,
        min_percentage=20.0,
    )
...
def test_compute_aggregates_without_prior_results_returns_empty_dict(
    ...
    assert eda_workflow.eda_workflow.compute_aggregates(sample_eda_dataframe) == {}
